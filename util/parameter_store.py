...
zd_24 = "(?:长期治疗：通|预防：|中度至重度食管炎：|反流性食管炎的长期治疗：|术前用药：|治疗佐林格-埃利森综合征时宜用大剂量|注射时的推荐剂量|预防用药剂量|与丙戊酸钠合用" \
        "|与酶诱导药（除丙戊酸钠之外）合用时|用于肾血管性高血压药物诊断|肾功能损害时|酒石酸盐美托洛尔|用于心律失常的急症处理|心功能Ⅲ〜IV级" \
            ...
            "|Ⅲ度或IV度|注射用药：|＞20kg,|NERD|对严重中毒|单用时：对轻度中毒|对中度中毒|对重度中毒|气管插管|外周血管疾病|球后注射|中度肾功能不全时|粉雾吸入：" \
            "|在肾功能障碍时|肌酐清除率10〜40ml/min时|肌酐清除率＜10ml/min|维拉帕米缓释片|严重心律失常应急|需要静脉给药时|结膜下注射|用于体外电除颤无效的室颤时" \
            "|反流性食管炎，|中度至重度食管炎|反流性食管炎的长期治疗|消化性溃疡：|治疗Hp感染|但在根除Hp治疗|抢救感染中毒性休克、改善微循环)+"

#按年龄、功能、作用切分时 含部分关键字的时候不进行切分
dose_forbid_24 = []
forbid_24 = ["一次4mg（3〜12岁）","门诊患者","住院患者","大部分患者","90%以上患者","1周疗法","应对患者进一步检査","对于反流性疾病的症状治疗","无发作","老年人及肝肾功能不全者","疗效不佳者可增加剂量",
...
zd_46 = "(?:闭角型青光眼急性发作，一次125|对于儿童患者|口服溶液剂|急性绞痛发作时|手术前、后|；混悬液|控释制剂|同时服稀盐酸|对于高剂量顺钳|肠镜、钡灌肠|具体用法如下|急性发作降结肠受累|缓解期|滴丸|门冬氨酸钾镁葡萄糖注射液" \
        ...
        "|；甲氧基聚乙二醇促红素|妊娠期妇女，|防止新生儿出血|静脉注射时溶解于|普外科手术时|在矫形外科手术中|合并肺栓塞时|根据性别和体重选择剂量|急性发作期" \
        ...
        "|术后预防静脉血栓|如存在其他毒副反应|b.如基础ANC低于|b.如基础血小板计数为|c.如基础血小板计数低于|如未达到血液学缓解|如第三次出现|以后根据血清生" \
        "|如已有乳汁分泌|抑制已有的泌乳|夜间遗尿症|男性每隔|女性可一次|或一次2mg|或一次口服|待病情改善和稳定后|或一次160mg|月经周期第11〜25日,)"

dose_forbid_46 = []
forbid_46 = ["静脉血栓栓塞危险消除","对于肝肾移植的儿童","当患者衰弱时","后者留置30分钟","适合更长的治疗周期","1 个月〜2岁","对恶心和呕吐的预防作用","6岁以下请遵医嘱","，12〜18 岁，",
             ",12〜18岁，","，12~18岁，","肾功能不全患者","有反复者","前者留置1小时","后者留置30分钟","除个别成人需强化治疗外","患者应立即补服利伐沙班","根据患者中心静脉压（CVP）"]
...
dose_forbid_68 = []
forbid_68 = ["体温正常者","严重全身感染患","AIDS患者","局部隆起部位","两者疗效相当"]
...
zd_810 = "(?:静脉滴注，首剂|抗生素相关性肠炎|幽门螺杆菌相关性胃窦炎|或每日15mg/kg|或一日1.5g|或每日按体重0.9|对敏感真菌所致感染|侵袭性曲霉菌病|再发性感染|反复发作性感染" \
...
dose_forbid_810 = []
forbid_810 = ["成人首剂静脉滴注","应在接触流感","任何患者","治疗中严重的中性粒细胞减少","需视患者病情及感染种类"]
...
zd_1012 = "(?:也可开始|缓释片：|缓释胶囊:|缓释片（胶囊）|一般抗炎及术后抗炎|控、缓释制剂：|其他非感染性炎症：|或酌情增为|急性疼痛：|缓释片，|通常肠溶片|建议在开始的3个月内" \
          "|起效后改为一日2次|由于服用本品|静脉给药一日8|或一日15|出现肝酶异常、中性粒细胞计数降低、血小板计数降低时|肌内注射一次20mg|肌内注射一次25|肌酐清除率＜30ml/min时" \
          ...
          "|甲状旁腺功能低下|慢性胆汁淤积：|溶液剂：|维生素AD滴剂|预防龋齿|溶液或糖浆剂|妊娠期妇女一日40|哺乳期妇女一日|有机磷制剂静脉滴注|经周围静脉给药时|加入载体溶液时用量的调整" \
...
dose_forbid_1012 = []
forbid_1012 = ["成人一次1〜2","口服维生素A10","首日口服10万","10岁以下","5岁以上小儿可用","对于肝肾移植的儿童","治疗肾病及肝硬化等慢性白蛋白缺乏症","则应根据其实际需要酌情增减"]
...
zd_1214 = "(?:亦可开始用较低剂量|冠状动脉内溶栓|据国内的临床研究|器械消毒以5|0.3%浓度|重金属中毒用量|静脉滴注，一次0.5g|腹壁皮下注射，|经口严重中毒|中度中毒0.5|重度中毒2.0" \
          ...
          "|心肌显像时如做一天法检查|胆红素不正常时|显像结束后，患|1期临床耐受性研究中|Ⅱ期无对照开放的临床研究用药剂量|肿瘤直径大于8cm时" \
