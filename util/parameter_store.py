...
dose_forbid_12=["维持量","极量","限量","最大量","总量","维持","继以","患者的耐受情况","耐受的用量","患者的反应和耐受程度"]
...
zd_46 = "(?:口服溶液剂|急性绞痛发作时|手术前、后|；混悬液|控释制剂|同时服稀盐酸|对于高剂量顺钳|肠镜、钡灌肠|具体用法如下|急性发作降结肠受累|缓解期|滴丸|门冬氨酸钾镁葡萄糖注射液" \
...
dose_forbid_46 = []
forbid_46 = ["当患者衰弱时","后者留置30分钟","适合更长的治疗周期","有高度出血倾向的血液透析","1 个月〜2岁","对恶心和呕吐的预防作用","6岁以下请遵医嘱","，12〜18 岁，",
