...
# admin_route_str = "(口服.灌肠|口服或舌下含服|舌下含服.舌下喷雾.黏膜给药|口服或静脉注射|餐?后?口服成?人?|含服|涂敷患?处?|喷于患处|外用|肌内注?射?或缓?慢?静脉缓?慢?注射|静脉注?射?或肌内注射" \
#                   "|肌内注射或缓?慢?静脉缓?慢?推注|皮下或肌内注射|肌内或皮下注射|皮下.肌内注射.缓慢静脉注射|肌内注射.静脉注射|心内注射或静脉注射|静脉注射|静脉滴注|球后注射|结膜下注射|深?部?肌内注射|皮下注射|静脉推注|静脉输注|静脉给药" \
#                   "|冲服|嚼服|浸润局麻|浸润麻醉|外用|滴眼|滴鼻|冲洗|阴道给药|肛门内?给药|舌下含服|阴道用药|瘤体注射|吸入|阴道冲洗|漱口|关节腔注射|处方|保留灌肠|灌肠|直肠灌注|贴患处|贴片" \
...
if __name__=="__main__":
    ...
    def data_pro_2list(filepath):
        ...
        if tmp:
            ...
            with open("C:/产品文档/转换器测试数据/1-200_20201124_cutsentence.json", "w", encoding='utf-8') as fp:
                for drug in tmp:
